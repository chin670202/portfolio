/**
 * Trade Parser - Uses Anthropic API to parse natural language trade descriptions
 * Migrated from server/services/trade-parser.js (Claude CLI → HTTP API)
 */
...
export async function parseTrade(input, env) {
